...
- 想用网页账号处理资料整理、信息查询、简单自动化、养虾养马这类轻中度任务，减少部分 API Token 消耗。
...
- [Qwen 3.7 接入轻量工具调用链路 Demo](docs/demos/agent-tool-calling.md)
...
- **Qwen 3.7 已就绪**：Qwen 3.7 Max、Qwen 3.7 Max Preview、Qwen 3.7 Plus Preview 已纳入直连模型目录和回归验证，适合在小龙虾、Hermes 等兼容客户端里做轻中度工具调用和低成本试错。
